...
class TestErrorClassification:
    ...
    def test_fatal_error(self):
        from freya.agents.errors import FatalError

        err = FatalError("invalid API key")
        assert err.retryable is False

    def test_escalate_error(self):
        from freya.agents.errors import EscalateError
    ...
    def test_classify_rate_limit(self):
        from freya.agents.errors import classify_error
    ...
    def test_retry_delay_exponential(self):
        from freya.agents.errors import retry_delay
