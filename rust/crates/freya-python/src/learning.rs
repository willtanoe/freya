...
use freya_learning::RouterPolicy;
use pyo3::prelude::*;

#[pyclass(name = "HeuristicRouter")]
pub struct PyHeuristicRouter {
    inner: freya_learning::HeuristicRouter,
}
...
impl PyHeuristicRouter {
    ...
    fn new(
        ...
        Self {
            inner: freya_learning::HeuristicRouter::new(
    ...
    fn select_model(&self, query: &str, has_code: bool, has_math: bool) -> String {
        let ctx = freya_core::RoutingContext {
...
pub struct PyBanditRouterPolicy {
    inner: freya_learning::BanditRouterPolicy,
}
...
impl PyBanditRouterPolicy {
    ...
    fn new(models: Vec<String>, strategy: &str) -> Self {
        let strat = match strategy {
            "ucb1" | "UCB1" => freya_learning::bandit::BanditStrategy::UCB1,
            _ => freya_learning::bandit::BanditStrategy::ThompsonSampling,
        };
        Self {
            inner: freya_learning::BanditRouterPolicy::new(models, strat),
        }
    }

    fn select_model(&self) -> String {
        let ctx = freya_core::RoutingContext::default();
        self.inner.select_model(&ctx)
    }
...
pub struct PyGRPORouterPolicy {
    inner: freya_learning::GRPORouterPolicy,
}
...
impl PyGRPORouterPolicy {
    ...
    fn new(models: Vec<String>, temperature: f64) -> Self {
        Self {
            inner: freya_learning::GRPORouterPolicy::new(models, temperature),
        }
    }
...
pub struct PyOptimizationStore {
    inner: parking_lot::Mutex<freya_learning::optimize::OptimizationStore>,
}
...
impl PyOptimizationStore {
    ...
    fn new(path: &str) -> PyResult<Self> {
        let store = if path == ":memory:" {
            freya_learning::optimize::OptimizationStore::in_memory()
        } else {
            freya_learning::optimize::OptimizationStore::open(path)
        };
        let store =
    ...
    fn save_trial(&self, run_id: &str, trial_json: &str) -> PyResult<()> {
        let trial: freya_learning::optimize::TrialResult =
...
pub struct PyLLMOptimizer {
    inner: freya_learning::optimize::LLMOptimizer,
}
...
impl PyLLMOptimizer {
    ...
    fn new(search_space_json: &str, optimizer_model: &str) -> PyResult<Self> {
        let search_space: freya_learning::optimize::SearchSpace =
            serde_json::from_str(search_space_json)
                .map_err(|e| PyErr::new::<pyo3::exceptions::PyValueError, _>(e.to_string()))?;
        let inner = freya_learning::optimize::LLMOptimizer::new(
            search_space,
    ...
    fn propose_next(&self, history_json: &str) -> PyResult<String> {
        let history: Vec<freya_learning::optimize::TrialResult> =
...
pub struct PySFTRouterPolicy {
    inner: freya_learning::SFTRouterPolicy,
}
...
impl PySFTRouterPolicy {
    ...
    fn new(min_samples: usize) -> Self {
        Self {
            inner: freya_learning::SFTRouterPolicy::new(min_samples),
        }
    }
    ...
    fn classify_query(query: &str) -> &'static str {
        freya_learning::SFTRouterPolicy::classify_query(query)
    }
...
pub struct PyHeuristicRewardFunction {
    inner: freya_learning::HeuristicRewardFunction,
}
...
impl PyHeuristicRewardFunction {
    ...
    fn new(
        ...
        Self {
            inner: freya_learning::HeuristicRewardFunction::new(
                weight_latency,
                weight_cost,
                weight_efficiency,
                max_latency,
...
pub struct PySkillDiscovery {
    inner: freya_learning::SkillDiscovery,
}
...
impl PySkillDiscovery {
    ...
    fn new(
        ...
        Self {
            inner: freya_learning::SkillDiscovery::new(
                min_frequency,
                min_sequence_length,
                max_sequence_length,
                min_outcome,
...
pub struct PyTraceDrivenPolicy {
    inner: freya_learning::TraceDrivenPolicy,
}
...
impl PyTraceDrivenPolicy {
    ...
    fn new(available_models: Vec<String>, default_model: &str, fallback_model: &str) -> Self {
        Self {
            inner: freya_learning::TraceDrivenPolicy::new(
                available_models,
                default_model.to_string(),
...
pub struct PyAgentAdvisorPolicy {
    inner: freya_learning::AgentAdvisorPolicy,
}
...
impl PyAgentAdvisorPolicy {
    ...
    fn new(max_traces: usize) -> Self {
        Self {
            inner: freya_learning::AgentAdvisorPolicy::new(max_traces),
        }
    }

    fn analyze_patterns(&self, traces_json: &str) -> PyResult<String> {
        let traces: Vec<freya_learning::TraceInfo> = serde_json::from_str(traces_json)
            .map_err(|e| PyErr::new::<pyo3::exceptions::PyValueError, _>(e.to_string()))?;
    ...
    fn classify(query: &str) -> &'static str {
        freya_learning::AgentAdvisorPolicy::classify(query)
    }
}
...
pub struct PyICLUpdaterPolicy {
    inner: freya_learning::ICLUpdaterPolicy,
}
...
impl PyICLUpdaterPolicy {
    ...
    fn new(min_score: f64, max_examples: usize, min_skill_occurrences: usize) -> Self {
        Self {
            inner: freya_learning::ICLUpdaterPolicy::new(
                min_score,
                max_examples,
...
pub struct PyTrainingDataMiner {
    inner: freya_learning::TrainingDataMiner,
}
...
impl PyTrainingDataMiner {
    ...
    fn new(min_quality: f64, min_samples_per_class: usize) -> Self {
        Self {
            inner: freya_learning::TrainingDataMiner::new(min_quality, min_samples_per_class),
        }
    }

    fn extract_sft_pairs(&self, traces_json: &str) -> PyResult<String> {
        let traces: Vec<freya_learning::MinerTraceData> = serde_json::from_str(traces_json)
            .map_err(|e| PyErr::new::<pyo3::exceptions::PyValueError, _>(e.to_string()))?;
...
pub struct PyAgentConfigEvolver {
    inner: freya_learning::AgentConfigEvolver,
}
...
impl PyAgentConfigEvolver {
    ...
    fn new(min_quality: f64) -> Self {
        Self {
            inner: freya_learning::AgentConfigEvolver::new(min_quality),
        }
    }

    fn analyze(&self, traces_json: &str) -> PyResult<String> {
        let traces: Vec<freya_learning::EvolutionTraceData> =
            serde_json::from_str(traces_json)
                .map_err(|e| PyErr::new::<pyo3::exceptions::PyValueError, _>(e.to_string()))?;
...
pub struct PyMultiObjectiveReward {
    inner: freya_learning::MultiObjectiveReward,
}
...
impl PyMultiObjectiveReward {
    ...
    fn new() -> Self {
        Self {
            inner: freya_learning::MultiObjectiveReward::new(
                freya_learning::RewardWeights::default(),
                freya_learning::Normalizers::default(),
            ),
        }
    }

    fn compute(&self, episode_json: &str) -> PyResult<f64> {
        let ep: freya_learning::Episode = serde_json::from_str(episode_json)
            .map_err(|e| PyErr::new::<pyo3::exceptions::PyValueError, _>(e.to_string()))?;
...
pub struct PyLearningOrchestrator {
    inner: freya_learning::LearningOrchestrator,
}
...
impl PyLearningOrchestrator {
    ...
    fn new(min_improvement: f64, min_sft_pairs: usize, min_quality: f64) -> Self {
        Self {
            inner: freya_learning::LearningOrchestrator::new(
                min_improvement,
                min_sft_pairs,
                min_quality,
            ),
