...
impl PyMessage {
    pub fn to_core(&self) -> freya_core::Message {
        let role = match self.role.as_str() {
            "system" => freya_core::Role::System,
            "assistant" => freya_core::Role::Assistant,
            "tool" => freya_core::Role::Tool,
            _ => freya_core::Role::User,
        };
        freya_core::Message {
            role,
...
#[pyclass(name = "Config")]
pub struct PyConfig {
    pub inner: freya_core::FreyaConfig,
}
...
impl PyConfig {
    ...
    fn new() -> Self {
        Self {
            inner: freya_core::FreyaConfig::default(),
        }
    }
...
pub struct PyEventBus {
    pub inner: std::sync::Arc<freya_core::EventBus>,
}
...
impl PyEventBus {
    ...
    fn new() -> Self {
        Self {
            inner: std::sync::Arc::new(freya_core::EventBus::new(true)),
        }
    }
