...
use freya_tools::executor::ToolExecutor;
...
mod tests {
    use super::*;
    use freya_tools::builtin::calculator::CalculatorTool;

    fn make_server() -> McpServer {
        let mut exec = ToolExecutor::new(None, None);
        exec.register(freya_tools::builtin::BuiltinTool::Calculator(CalculatorTool));
