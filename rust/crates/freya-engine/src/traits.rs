...
use freya_core::{GenerateResult, Message, Role};
use serde_json::Value;
use std::pin::Pin;
use tokio_stream::Stream;

pub type StreamItem = Result<String, freya_core::FreyaError>;
...
pub trait InferenceEngine: Send + Sync {
    ...
    fn generate(
        ...
        max_tokens: i64,
        extra: Option<&Value>,
    ) -> Result<GenerateResult, freya_core::FreyaError>;
    ...
    async fn stream(
        ...
        max_tokens: i64,
        extra: Option<&Value>,
    ) -> Result<TokenStream, freya_core::FreyaError>;

    fn list_models(&self) -> Result<Vec<String>, freya_core::FreyaError>;
...
mod tests {
    use super::*;
    use freya_core::{Message, ToolCall};
