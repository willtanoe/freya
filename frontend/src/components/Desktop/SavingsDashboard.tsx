...
const OPTIN_KEY = 'freya-desktop-optin';
const OPTIN_NAME_KEY = 'freya-desktop-display-name';
const OPTIN_EMAIL_KEY = 'freya-desktop-email';
const OPTIN_ANONID_KEY = 'freya-desktop-anon-id';
