...
Single source of truth for every event name and property the Freya
...
see :mod:`freya.analytics.redaction` for the value-level filters.
...
_SPECS: tuple[EventSpec, ...] = (
    ...
    EventSpec(
        ...
        description="`freya init` finished and config.toml was written.",
        properties={
