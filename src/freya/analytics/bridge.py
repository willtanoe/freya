...
The internal bus (:mod:`freya.core.events`) carries dozens of
...
from freya.analytics.redaction import hash_id
from freya.core.events import Event, EventType
    ...
    def _on_tool_end(self, event: Event) -> None:
        try:
            ...
            if first:
                ...
                from freya.analytics.events import KNOWN_TOOL_NAMES
