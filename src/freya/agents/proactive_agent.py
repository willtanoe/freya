...
called from your app startup:
    ...
    from freya.agents.proactive_agent import register_cron
...
from freya.tools.proactive_tools import get_store
    ...
    if channel_type == "imessage":
        ...
        class _IMessageShim(BaseChannel):
            ...
            def send(
                ...
                from freya.channels.imessage_daemon import send_imessage
...
class ProactiveAgent(ToolUsingAgent):
    ...
    def __init__(self, *args: Any, **kwargs: Any) -> None:
        ...
        from freya.tools.proactive_tools import (
            CheckPermissionTool,
    ...
    def _build_system_prompt(self) -> str:
        user_md = _load_md_file(Path.home() / ".freya" / "USER.md")
        memory_md = _load_md_file(Path.home() / ".freya" / "MEMORY.md")
        now = datetime.now()
        context_block = ""
