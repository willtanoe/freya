...
class AgentManager:
    ...
    def __init__(self, db_path: str, *, clear_stale_running: bool = False) -> None:
        ...
        # commands (`freya agents list/info/...`) and the SystemBuilder path
    ...
    def create_agent(
        ...
        from freya.agents.executor import _AGENT_TICK_DEFAULT_MODEL
    ...
    def list_templates() -> List[Dict[str, Any]]:
        ...
        # Built-in templates
        try:
            tpl_dir = importlib.resources.files("freya.agents") / "templates"
        ...
        # User templates
        user_dir = Path("~/.freya/templates").expanduser()
        if user_dir.is_dir():
