...
def _load_persona(persona_name: str) -> str:
    ...
    search_paths = [
        Path("configs/freya/prompts/personas") / f"{persona_name}.md",
        Path.home() / ".freya" / "prompts" / "personas" / f"{persona_name}.md",
    ]
...
class MorningDigestAgent(ToolUsingAgent):
    ...
    def __init__(self, *args: Any, **kwargs: Any) -> None:
        ...
        self._persona = kwargs.pop("persona", "freya")
    ...
    def run(
        ...
        **kwargs: Any,
        ...
        evaluator_feedback = ""
        try:
            from freya.agents.digest_evaluator import DigestEvaluator
        ...
        output_dir = str(Path.home() / ".freya" / "digests")
        tts_call = ToolCall(
            id="digest-tts-1",
            name="text_to_speech",
