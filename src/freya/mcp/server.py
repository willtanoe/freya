"""MCP Server — wraps Freya tools as MCP-discoverable tools."""
...
class MCPServer:
    """MCP server that exposes Freya tools via JSON-RPC.
    ...
    def _auto_discover_tools() -> List[BaseTool]:
        ...
        try:
            ...
            pass
        try:
            from freya.tools.code_interpreter import CodeInterpreterTool

            _tool_classes.append(CodeInterpreterTool)
        except ImportError:
            pass
        try:
            from freya.tools.repl import ReplTool
