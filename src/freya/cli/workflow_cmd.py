"""``freya workflow`` — workflow management commands."""
...
def list_workflows() -> None:
    ...
    try:
        from freya.workflow.loader import discover_workflows
...
def run(workflow_name: str, input_text: str | None) -> None:
    ...
    try:
        ...
        # Full execution would need a FreyaSystem — just report for now
        console.print(
