"""``freya ask`` — send a query to the assistant."""
...
from freya.cli._tool_names import resolve_tool_names
from freya.cli.hints import hint_no_engine
...
def _run_research(
    *,
    ...
    from freya.agents.research_loop import DEFAULT_PLANNER_MODEL, ResearchAgent
    from freya.connectors.embeddings import OllamaEmbedder
    from freya.connectors.hybrid_search import HybridSearch
    ...
    # (so ``freya ask --research "..." > out.md`` still gives a clean
...
@click.option(
    ...
    default=None,
    help=(
        "Named persona dir under ~/.freya/personas/<name>/ "
...
def ask(
    ...
    # the most common command (`freya ask "..."`).
    ...
    if resolved is None:
        console.print(
            ...
            "  [cyan]freya config set engine.ollama.host http://<remote-ip>:11434[/cyan]\n"
