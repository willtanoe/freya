"""``freya serve`` — OpenAI-compatible API server."""
...
def serve(
        ...
        try:
            ...
            if AgentRegistry.contains(agent_key):
                ...
                if getattr(agent_cls, "accepts_tools", False):
                    import freya.tools  # noqa: F401  # trigger registration
            ...
            try:
                ...
                if AgentRegistry.contains(channel_agent):
                    ...
                    if getattr(_ch_cls, "accepts_tools", False):
                        ...
                        # FreyaSystem below; we extend its lifetime by
    ...
    api_key = _os.environ.get("FREYA_API_KEY", "")
    if not api_key:
        try:
            import tomllib
    ...
    from freya.core.credentials import TOOL_CREDENTIALS, get_credential_status
