"""LLM-based optimizer for Freya configuration tuning.

Uses a cloud LLM to propose optimal Freya configs, inspired by DSPy's
...
class LLMOptimizer:
    """Uses a cloud LLM to propose optimal Freya configs.
    ...
    def _build_initial_prompt(self) -> str:
        ...
        lines: List[str] = []
        lines.append("You are optimizing an Freya AI system configuration.")
        lines.append("")
    ...
    def _build_analyze_prompt(
        ...
        lines: List[str] = []
        lines.append("Analyze this Freya evaluation result.")
        lines.append("")
