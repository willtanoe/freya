...
<title>Freya — Cost Comparison</title>
<style>
...
<div class="header">
  <h1><span>Freya</span> Cost Comparison</h1>
  <div class="nav">
...
<div class="container">
  ...
  <div class="hero">
    ...
    <div class="sub">
      Freya runs models on your own hardware. Every inference call that would
...
document.getElementById('copy-btn').addEventListener('click', () => {
  const cmd = 'git clone https://github.com/freya-ai/'
    + 'Freya.git && cd Freya && uv sync';
