...
from freya.agents._stubs import AgentContext, BaseAgent
from freya.core.events import Event, EventBus, EventType
    ...
    async def stream(self) -> AsyncGenerator[str, None]:
        ...
        try:
            ...
            try:
                ...
                logger = logging.getLogger("freya.server")
            ...
            if engine is not None and hasattr(engine, "stream_full") and content:
                ...
                try:
                    from freya.core.types import Message as MsgType
                    from freya.core.types import Role as RoleType
                    ...
                    _logger = _logging.getLogger("freya.server")
                    _logger.warning(
