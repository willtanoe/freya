...
_OUTPUT_START = "---FREYA_OUTPUT_START---"
_OUTPUT_END = "---FREYA_OUTPUT_END---"
...
class ContainerRunner:
    ...
    ----------
    image:
        Docker image to run.  Defaults to ``freya-sandbox:latest``.
    timeout:
    ...
    DEFAULT_IMAGE = "freya-sandbox:latest"
    DEFAULT_TIMEOUT = 300
