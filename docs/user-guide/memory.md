...
- **Persistence:** SQLite database file (default: `~/.freya/memory.db`)
...
!!! note "Backward compatibility"
    The old `from freya.memory.bm25 import BM25Memory` still works via backward-compatibility shims, but new code should use the canonical `freya.tools.storage.*` imports.
...
[Source: docs/intro.md] Freya is a modular AI framework...
...
freya memory index ./notes/ --chunk-size 256 --chunk-overlap 32

# Search the memory store
freya memory search "machine learning"
